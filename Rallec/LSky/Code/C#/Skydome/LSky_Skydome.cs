...
namespace Rallec.LSky
{
	[ExecuteInEditMode] public class LSky_Skydome : MonoBehaviour
	{
		...
		private void Celestials()
		{
			...
			Shader.SetGlobalVector(lsky_LocalSunDirectionID, SunDirection);

			// Set sun direction in world space.
			Shader.SetGlobalVector(lsky_WorldSunDirectionID, m_Transform.InverseTransformDirection(SunDirection));
			//======================================================================================================
		...
		#region |Accessors|Atmosphere|

		public bool RenderAtmosphere { get => m_RenderAtmosphere; set => m_RenderAtmosphere = value; }
		public int AtmosphereLayerIndex { get => m_AtmosphereLayerIndex; set => m_AtmosphereLayerIndex = value; }
		public LSky_AtmosphereModel AtmosphereModel { get => m_AtmosphereModel; set => m_AtmosphereModel = value; }
		public LSky_Quality3 AtmosphereMeshQuality { get => m_AtmosphereMeshQuality; set => m_AtmosphereMeshQuality = value; }
		public LSky_ShaderQuality AtmosphereShaderQuality { get => m_AtmosphereShaderQuality; set => m_AtmosphereShaderQuality = value; }
		public bool RealTimeBetaMie { get => m_RealTimeBetaMie; set => m_RealTimeBetaMie = value; }
		public bool RealTimeBetaRay { get => m_RealTimeBetaRay; set => m_RealTimeBetaRay = value; }
		public bool RealTimeBetaMie1 { get => m_RealTimeBetaMie; set => m_RealTimeBetaMie = value; }
		public bool RealTimeBetaRay1 { get => m_RealTimeBetaRay; set => m_RealTimeBetaRay = value; }
		public int AtmosphereSamples
		{
			get => m_AtmosphereSamples; set => m_AtmosphereSamples = value;
		}
		...
		public AnimationCurve RayleighScattering { get => m_RayleighScattering; set => m_RayleighScattering = value; }
		public float AtmosphereHaziness { get => m_AtmosphereHaziness; set => m_AtmosphereHaziness = value; }
		public float AtmosphereZenith { get => m_AtmosphereZenith; set => m_AtmosphereZenith = value; }
		public AnimationCurve SunBrightness { get => m_SunBrightness; set => m_SunBrightness = value; }
		public Gradient DayAtmosphereTint { get => m_DayAtmosphereTint; set => m_DayAtmosphereTint = value; }
		public LSky_NightRayleighMode NightRayleighMode { get => m_NightRayleighMode; set => m_NightRayleighMode = value; }
		public float MoonBrightness { get => m_MoonBrightness; set => m_MoonBrightness = value; }
		public Color NightAtmosphereTint { get => m_NightAtmosphereTint; set => m_NightAtmosphereTint = value; }
		public float Mie { get => m_Mie; set => m_Mie = value; }
		public Gradient SunMieColor { get => m_SunMieColor; set => m_SunMieColor = value; }
		public float SunMieAnisotropy { get => m_SunMieAnisotropy; set => m_SunMieAnisotropy = value; }
		public AnimationCurve SunMieScattering { get => m_SunMieScattering; set => m_SunMieScattering = value; }
		public Gradient MoonMieColor { get => m_MoonMieColor; set => m_MoonMieColor = value; }
		public float MoonMieAnisotropy { get => m_MoonMieAnisotropy; set => m_MoonMieAnisotropy = value; }
		public AnimationCurve MoonMieScattering { get => m_MoonMieScattering; set => m_MoonMieScattering = value; }
		public float AtmosphereExponentFade { get => m_AtmosphereExponentFade; set => m_AtmosphereExponentFade = value; }

        #endregion |Accessors|Atmosphere|

        #region |Accessors|Clouds|

        public bool RenderClouds { get => m_RenderClouds; set => m_RenderClouds = value; }
        public int CloudsLayerIndex { get => m_CloudsLayerIndex; set => m_CloudsLayerIndex = value; }
        public float CloudsMeshHeightSize
		{
			get { return m_CloudsMeshHeightSize; }
			set { m_CloudsMeshHeightSize = value; }
		}

        public float CloudsRotationSpeed { get => m_CloudsRotationSpeed; set => m_CloudsRotationSpeed = value; }
        public bool NoiseBasedClouds { get => m_NoiseBasedClouds; set => m_NoiseBasedClouds = value; }
        public Gradient CloudsColor { get => m_CloudsColor; set => m_CloudsColor = value; }
        ...
        public Gradient CloudsEdgeColor { get => m_CloudsEdgeColor; set => m_CloudsEdgeColor = value; }
        public Gradient CloudsMoonColor { get => m_CloudsMoonColor; set => m_CloudsMoonColor = value; }
        public float CloudsEdgeColorHeight { get => m_CloudsEdgeColorHeight; set => m_CloudsEdgeColorHeight = value; }
        public float CloudsTransparency { get => m_CloudsTransparency; set => m_CloudsTransparency = value; }
        ...
        public float CloudsSmoothness { get => m_CloudsSmoothness; set => m_CloudsSmoothness = value; }
        public float CloudsDistortionScale { get => m_CloudsDistortionScale; set => m_CloudsDistortionScale = value; }
        public float CloudsDistortion { get => m_CloudsDistortion; set => m_CloudsDistortion = value; }
        public Texture2D CloudsTexture { get => m_CloudsTexture; set => m_CloudsTexture = value; }
        public Vector2 CloudsSize { get => m_CloudsSize; set => m_CloudsSize = value; }
        public Vector2 CloudsTexOffset { get => m_CloudsTexOffset; set => m_CloudsTexOffset = value; }
        public float CloudsDensity { get => m_CloudsDensity; set => m_CloudsDensity = value; }
        ...
        #endregion |Accessors|Clouds|

        #region |Accessors|Lighting|
        ...
        public Gradient SunLightColor { get => m_SunLightColor; set => m_SunLightColor = value; }
        ...
        public Gradient MoonLightColor { get => m_MoonLightColor; set => m_MoonLightColor = value; }

        public AnimationCurve SunMoonLightFade { get => m_SunMoonLightFade; set => m_SunMoonLightFade = value; }
        public bool SendSkybox { get => m_SendSkybox; set => m_SendSkybox = value; }
        public float AmbientUpdateInterval { get => m_AmbientUpdateInterval; set => m_AmbientUpdateInterval = value; }
        public Gradient AmbientGroundColor { get => m_AmbientGroundColor; set => m_AmbientGroundColor = value; }

        // Fog
        //---------------------------------------------------------------------------------------

        public bool EnableUnityFog { get => m_EnableUnityFog; set => m_EnableUnityFog = value; }
        ...
        public Gradient UnityMoonFogColor { get => m_UnityMoonFogColor; set => m_UnityMoonFogColor = value; }
